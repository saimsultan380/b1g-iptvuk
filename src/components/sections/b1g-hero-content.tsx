  ...
  return (
    <div className="flex flex-col items-start text-left w-full">
      ...
      <div className="mt-4 sm:mt-6 space-y-3 sm:space-y-4 text-xs sm:text-sm lg:text-base text-[#4A4A4A] leading-relaxed">
        ...
        <p data-reveal data-delay="40" className={showFullBodyCopy ? "block" : "hidden sm:block"}>
        ...
        <p data-reveal data-delay="80" className={showFullBodyCopy ? "block" : "hidden sm:block"}>
        ...
        <p data-reveal data-delay="120" className={showFullBodyCopy ? "block" : "hidden sm:block"}>
